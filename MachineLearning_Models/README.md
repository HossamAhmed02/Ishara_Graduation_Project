...
Due to size limits, the heavy model files must be downloaded from Google Drive and placed in their respective folders:
...
GET /docs: Interactive Swagger documentatio
